...
public class HomeAdapter extends RecyclerView.Adapter<HomeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final HomeViewHolder holder, final int position) {
        ...
        holder.nameAgeRelationship.setText(String.format("%s %s, %s, %s", userModelArrayList.get(position).getName(), userModelArrayList.get(position).getLastName(), userModelArrayList.get(position).getAge(), userModelArrayList.get(position).getRelationship()));
        holder.profession.setText(userModelArrayList.get(position).getOccupation());
        holder.state.setText("From "+userModelArrayList.get(position).getNativeState());
        holder.city.setText(String.format("Lives in %s", userModelArrayList.get(position).getCity()));
        ...
        Log.i("length",String.valueOf(holder.height.length()));
