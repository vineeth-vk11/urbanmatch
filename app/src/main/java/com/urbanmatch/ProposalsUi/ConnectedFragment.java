...
import com.urbanmatch.ProposalsUi.ProposalAdapter.ConnectedAdapter;
...
public class ConnectedFragment extends Fragment {
    ...
    private void getAcceptedRequests() {
        ...
        db.collection("userData").document(uid).collection("Accepted").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable final FirebaseFirestoreException e) {
                ...
                if(queryDocumentSnapshots != null){
                    ...
                    Log.i("connected size", String.valueOf(sentRequestModelArrayList.size()));
                    ConnectedAdapter connectedAdapter = new ConnectedAdapter(getContext(),sentRequestModelArrayList);
